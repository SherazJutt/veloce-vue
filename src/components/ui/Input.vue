...
<template>
	<div :class="{ 'mb-6': helpText }" class="relative h-[42px]">
		<input type="text" v-model="model" class="hover:border-primary/60 peer outline-primary h-full w-full rounded-md border border-gray-200 px-3 duration-200" placeholder=" " />
