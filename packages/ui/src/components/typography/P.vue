...
const props = defineProps({
  ...
  fontSize: { type: String as () => FontSize, default: "md" as FontSize },
  color: { type: String as () => TextColor, default: "default" as TextColor },
  fontWeight: { type: String as () => FontWeight, default: "normal" as FontWeight },
  lineHeight: { type: String as () => LineHeight, default: "" },
  ...
  marginTop: { type: String as () => Margin, default: "xs" },
...
<template>
  <p :class="classes" v-html="props.text" />
</template>
