...
const classes = computed(() => {
  return [colorClasses[props.severity] || colorClasses.default, fontWeightClasses[props.fontWeight] || fontWeightClasses.bold, props.noMargin ? "" : "mb-4 mt-6", "text-4xl leading-tight "];
});
</script>
